...
I first read in the raw data, and then begin to clean it.  I filter for rows in which significant strikes are actually landed and then select the desired features. Lastly, I create the response variable, rwin.
```{r, warning = F, message = F}
MMA <- read_csv("raw_data.csv" ) 
